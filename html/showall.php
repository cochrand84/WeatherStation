...
<html>
    ...
    <head>
        ...
        <title>All Weather Recorded</title>
...
AmCharts.loadJSON = function(url) {
  ...
  return eval(request.responseText);
        ...
        <script>
            ...
            var chartData3 = AmCharts.loadJSON('outside_temp_data_all.php');
		...
		<script>
            ...
            var graph;
			// here we are going to load the php file that has our json data
            var chartData = AmCharts.loadJSON('outside_temp_data_all.php');
		...
		<script>
            ...
            var graph;
			// here we are going to load the php file that has our json data
            var chartData2 = AmCharts.loadJSON('inside_temp_data_all.php');
	...
	<center><a href="index.php">Return to current data</a><p></p><a href="deletealldata.php">delete all data!</a>
